...
{
    // public static readonly StyledProperty<bool> IsEverySecondModeProperty = AvaloniaProperty.Register<SecondsCronPickerFieldItem, bool>(nameof(IsEverySecondMode), defaultBindingMode: BindingMode.TwoWay);
